            ...
            <div className="flex justify-center items-start pt-4">
                <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
                    <ListItem>
                        ...
                        <ListItemText primary="Certification of Death - Physician Statement" secondary=" Upload Date: Oct 28, 2023" />
                        <ListItemAvatar>
                            <Avatar>
                                <DeleteIcon />
                            </Avatar>
                    ...
                    <ListItem>
                        ...
                        <ListItemText primary="Life Claim Information Request" secondary="Upload Date: Nov 7, 2023" />
                        <ListItemAvatar>
                            <Avatar>
                                <DeleteIcon />
                            </Avatar>
