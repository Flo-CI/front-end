          ...
          <Grid item>
            <h2>
              <Stack style={{justifyContent: 'center'}} spacing={2} direction="row" sx={{m: 2}}>
                ...
                <Button variant="contained" color="success" onClick={() => handleAccountNumberChange()}>Check Claim Number</Button>
              </Stack>
            </h2>
          </Grid>
          <Grid item>
            <h2>
              <TextField id="filled-basic" label="Please enter claim number" variant="filled"
                         color="success" onChange={handleTextboxValueChange} sx={{m: 3, width: '42ch'}}/>
            </h2>
          </Grid>
        </Grid>
      </div>
